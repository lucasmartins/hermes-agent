...
OPTIONAL_ENV_VARS = {
    ...
    "QWEN3_ASR_BASE_URL": {
        "description": "Qwen3 ASR OpenAI-compatible /v1 endpoint for speech-to-text (e.g. http://127.0.0.1:8002/v1)",
        "prompt": "Qwen3 ASR base URL",
        "url": None,
        "password": False,
        "category": "tool",
        "advanced": True,
    ...
    "QWEN3_ASR_HOST": {
        "description": "Qwen3 ASR host alias for local speech-to-text services (e.g. 127.0.0.1:8101); normalized to /v1 automatically",
        "prompt": "Qwen3 ASR host",
        "url": None,
        "password": False,
        "category": "tool",
        "advanced": True,
    ...
    "QWEN3_ASR_API_KEY": {
        "description": "Qwen3 ASR API key for hosted/proxied speech-to-text endpoints (optional for local servers)",
        "prompt": "Qwen3 ASR API key",
        "url": None,
        "password": True,
        "category": "tool",
        "advanced": True,
    ...
    "QWEN3_ASR_MODEL": {
        "description": "Qwen3 ASR model override for speech-to-text (e.g. Qwen/Qwen3-ASR-1.7B)",
        "prompt": "Qwen3 ASR model",
        "url": None,
        "password": False,
        "category": "tool",
        "advanced": True,
    ...
    "QWEN3_ASR_LANGUAGE": {
        "description": "Qwen3 ASR language hint for speech-to-text (optional, e.g. english or chinese)",
        "prompt": "Qwen3 ASR language hint",
        "url": None,
        "password": False,
        "category": "tool",
        "advanced": True,
